...
I know that I enjoy what software engineering affords with creating, editing, and updating software programs, databases, and applications. I also know that I enjoy analyzing information that is collected to share and interpret with heads of the organization. In blending the two, I have found that data engineers oversee and works with both programming and data frameworks. I aim to achieve the status of a data scientist/data engineer. I would like to pursue this position now that I am learning code to develop algorithms that satisfy analytical reasoning for reports. At some point in my career, I would like to teach students the knowledge and skills based on my experience in the industry.
